...
def report_node(state: AgentState) -> dict:
    ...
    try:
        # Initialize LLM
        from langchain_groq import ChatGroq
        llm = ChatGroq(api_key=settings.GROQ_API_KEY, model_name="openai/gpt-oss-120b", temperature=0.3)
        
        # Define Prompt
        prompt = ChatPromptTemplate.from_messages([
            ("system", "You are the final VitalGate AI reporting agent. Do NOT output long paragraphs. Output a highly precise, top-tier clinical summary for the patient using bullet points. Be empathetic but direct. Format EXACTLY like this:\n\n**Urgency Level:** {urgency}\n**Recommended Department:** {dept}\n\n**Key Finding:** [1-2 sentences max explaining the cause simply based on Reasoning]\n\n**Next Steps:**\n- [Action 1]\n- [Action 2]\n\n**Appointment Info:** {apt_status}"),
