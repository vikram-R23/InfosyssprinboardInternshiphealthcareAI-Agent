...
import { Bot, MoreVertical, Paperclip, Send, X, Mic, MicOff, Volume2, VolumeX } from 'lucide-react';
...
export default function SymptomChecker() {
  ...
  return (
    <div className="flex-grow flex flex-col max-w-4xl mx-auto w-full relative pt-4 pb-4 px-4 md:px-6 h-[calc(100vh-73px)]">
